...
fprintf('begin to ensemble obj.....\n')
R = gamrnd(0.03,2/(m*e*1.9),1,n-1);
K=20;
...
fprintf('end to ensemble obj\n')

fprintf('begin to obj.....\n')
R
weights41=OPSFZ(ztrain,R);
[w_weight41,w_site41]=sort(weights41);
[saccu,kaccu]=SVM_KNN( train,test,w_site41,f );
fprintf('end to obj\n')

fprintf('begin to non.....\n')
weights44=OPSFZ(ztrain,0);
[w_weight44,w_site44]=sort(weights44);
